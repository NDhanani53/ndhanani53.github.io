...
# Bar chart: total salary by position
...
ggplot(nfl_long, aes(x = position, y = salary)) +
  ...
  theme_minimal() +
  labs(title = "NFL Salaries by Position", x = "Position", y = "Salary", alt = "This chart compares NFL salaries by position. Each box shows the range of salaries for a position across all years, with the line inside representing the median. Taller or higher boxes indicate higher or more variable salaries.
Quarterbacks and Offensive Linemen tend to earn the most, while positions like Special Teamers and Tight Ends earn less and show less variation in pay.") +
