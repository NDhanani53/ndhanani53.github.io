...
ggplot(NYTimesv3, aes(x = Year, y = article_count)) +
  ...
  labs(title = "Political Articles Mentioning Key Locations Over Time",
       x = "Year",
       y = "Number of Articles",
       alt = "Line chart showing the number of political articles in the NYTimes each year that mention major global locations. The line shows an overall decrease in political menioning but fluctuates in time periods where their is increasing and decreasing amount of political mentions in articles.") +
  theme_minimal()
```
