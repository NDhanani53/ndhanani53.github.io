...
```{r echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, fig.alt="Line chart showing search rates over time for Black and White drivers across five U.S. cities. Each panel represents a different city, and within each panel, two lines track yearly search rates by race."}
...
```{r echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, fig.alt="Bar chart comparing total traffic stops of Black and White drivers across five U.S. cities. Each city has two bars side-by-side showing total stops by race."}
