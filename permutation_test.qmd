...
```{r, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, fig-alt: "Boxplot comparing financial account ownership rates (age 15+) between high-GDP and low-GDP countries. The plot shows that high-GDP countries tend to have higher median account ownership, with less variation compared to low-GDP countries."}
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, fig-alt: "Histogram showing the distribution of permuted differences in means of financial account ownership (age 15+) between low-GDP and high-GDP countries. A red vertical line indicates the observed difference from the actual data."}
...
```{r, echo=TRUE, warning=FALSE, message=FALSE, error=FALSE, fig-alt: "Histogram showing the distribution of permuted differences in medians of financial account ownership (age 15+) between low-GDP and high-GDP countries. A blue vertical line marks the observed median difference from the real data."}
